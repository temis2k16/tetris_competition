...
logging.basicConfig(filename='logging.txt', filemode='w', format="%(asctime)s %(levelname)s:%(message)s", level=logging.INFO)
...
def turn(gcb: Board) -> TetrisAction:
    ...
    return [
        TetrisAction.LEFT, TetrisAction.DOWN
...
if __name__ == "__main__":
    ...
    uri = "http://codebattle2020.westeurope.cloudapp.azure.com/codenjoy-contest/board/player/ijb8d0ticthn42a0cwn3?code=1050572501494885536&gameName=tetris"
    main(uri)
